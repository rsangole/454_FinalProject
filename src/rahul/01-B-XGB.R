...
(lrn <- makeLearner(cl = "classif.xgboost", id = "model1_xbg", nrounds=400, verbose = 0, max_depth = 8))
...
xgb.ggplot.deepness(getLearnerModel(mod))

xgbFit <- getLearnerModel(mod)
xgbFit$evaluation_log %>% plot
